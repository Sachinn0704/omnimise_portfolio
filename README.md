...
**Backend & APIs:** Flask, FastAPI, Streamlit (for model-backed services)
**Databases:** MySQL, SQLite, MongoDB  
**AI/ML & Vision:** TensorFlow, OpenCV, Scikit-learn, Pandas, NumPy, Matplotlib, Seaborn 
**Frontend Basics:** HTML, CSS, JavaScript (for dashboards and admin panels) 
...
- **Gas Leak Monitoring System (Arduino):** Real-time sensor monitoring and alert logic. 
- **Retail Shop Inventory Manager:** Basic backend-style CRUD logic for stock management.  
...
- Data Engineering Professional & Data Science Foundation – Great Learning .
...
- **Hackathons / Programs:** Zerodha Versity Quiz, TCS Tech Bytes, Personal Effectiveness Program (communication and teamwork).  
- **Languages:** English (Professional), Kannada (Native), Hindi (Limited). 
- **Interests:** Open-source software, Cricket, Teaching, Fitness.
- 
📬 Let’s Connect!
---
- 📍 Bengaluru, Karnataka  
- 🎓 B.Tech CSE (Data Science), Dayanand Sagar University — CGPA: 8.36/10  
- 📧 sachinbhosagi09@gmail.com  
- 📞 +91-8861684615  
- 🔗 [LinkedIn](https://www.linkedin.com/in/sachin-b-9aaa67259/) · [GitHub](https://github.com/Sachinn0704)  
